  ...
  'Employee Help': {
    ...
    Reports: [
      ...
      },
      {
        ...
        articleGroup: 'all-categories',
        body: [
          { heading: 'What is Group class report?' },
          'Group class report shows all group fitness classes in one place — class name, trainer, members enrolled, schedule, attendance, and class status for the date range you pick.',
          'It sits under Staff on the All reports page, after Package wise report. Use it to review class activity and member participation.',
          { heading: 'How to open' },
          'Open Reports from the left menu, go to All categories, then pick Group class from the report list.',
          'Step 1: Reports → All categories.',
          'Step 2: On All reports, use Category chips (Staff, etc.) or search Filter reports by name.',
          'Step 3: Click Group class under Staff — open the group class report (see below).',
        ],
        image: '/employee-help-group-class-report-all-reports.png?v=0630c',
        imageAlt:
          'All reports page with Group class card under Staff highlighted and click callout',
        imageWide: true,
      },
      {
        title: 'Group class manage',
        articleGroup: 'all-categories',
        body: [
          { heading: 'What is Group class manage?' },
          'Group class manage lets you manage all group fitness classes — create, edit, reschedule, or cancel classes, assign trainers, set capacity, and update class details.',
          'It sits under Staff on the All reports page, after Group class report. Use it to set up and maintain your group class schedule.',
          { heading: 'How to open' },
          'Open Reports from the left menu, go to All categories, then pick Group class manage from the report list.',
          'Step 1: Reports → All categories.',
          'Step 2: On All reports, use Category chips (Staff, etc.) or search Filter reports by name.',
          'Step 3: Click Group class manage under Staff — open group class management (see below).',
        ],
        image: '/employee-help-group-class-manage-all-reports.png?v=0630d',
        imageAlt:
          'All reports page with Group class manage card under Staff highlighted and click callout',
        imageWide: true,
        bodyEnd: [
          { heading: 'Group Class Manage page' },
          { heading: 'What this page shows' },
          'After you click Group class manage, the Group Class Manage page opens — all created group classes with name, location, map link, max members, and enrolled count.',
          'Use ADD GROUP CLASS to create a new class. The table lists each class — edit details, add sub-classes or sessions, or delete from Actions.',
          { heading: 'How to use this page' },
          'Step 4: Click ADD GROUP CLASS — enter class name, location, and capacity.',
          'Step 5: Check the table — Group Class Name, Event Location, Max Members, Total Members.',
          'Step 6: Use Edit, Add, or Delete in Actions to update or remove a class (see guide below).',
        ],
        image3: '/employee-help-group-class-manage-page.png?v=0630e',
        image3Alt:
          'Group Class Manage page with ADD GROUP CLASS button, class table, and numbered guide',
        image3Wide: true,
        image3Bleed: true,
      },
      {
        title: 'PT summary report',
        articleGroup: 'all-categories',
        body: [
          { heading: 'What is PT summary report?' },
          'PT summary report shows a summary of all Personal Training sessions — PT name, total sessions, completed sessions, pending sessions, and revenue generated for the date range you pick.',
          'It sits under Staff on the All reports page, after Group class manage. Use it to review trainer activity and PT revenue at a glance.',
          { heading: 'How to open' },
          'Open Reports from the left menu, go to All categories, then pick PT summary from the report list.',
          'Step 1: Reports → All categories.',
          'Step 2: On All reports, use Category chips (Staff, etc.) or search Filter reports by name.',
          'Step 3: Click PT summary under Staff — open the PT summary report (see below).',
        ],
        image: '/employee-help-pt-summary-report-all-reports.png?v=0630f',
        imageAlt:
          'All reports page with PT summary report card under Staff highlighted and click callout',
        imageWide: true,
        bodyEnd: [
          { heading: 'PT Summary Report page' },
          { heading: 'What this page shows' },
          'After you click PT summary, the PT Summary Report page opens — approved, pending, and rejected sessions with transactions, trainers, members, and amount.',
          'Filter by Staff/Trainer, Month, and Year. Check Overall Totals, Trainer Breakdown, and Monthly Trend at the bottom.',
          { heading: 'How to use this page' },
          'Step 4: Pick Staff/Trainer, Month, and Year — or click Clear Filters to reset.',
          'Step 5: Check Approved, Pending, and Rejected cards, then Overall Totals.',
          'Step 6: Read Trainer Breakdown and Monthly Trend tables (see guide below).',
        ],
        image3: '/employee-help-pt-summary-report-page.png?v=0630g',
        image3Alt:
          'PT Summary Report page with filters, status cards, totals, trainer breakdown, and numbered guide',
        image3Wide: true,
        image3Bleed: true,
      },
      {
        ...
        articleGroup: 'all-categories',
        body: [
          { heading: 'What is Reward points report?' },
          'Reward points report helps you view and track all reward points earned and redeemed by members, along with their current balance and transaction history.',
          'It sits under Incentive on the All reports page, after PT summary report. Use it to monitor your gym’s loyalty program in one place.',
          { heading: 'How to open' },
          'Open Reports from the left menu, go to All categories, then pick Reward points from the report list.',
          'Step 1: Reports → All categories.',
          'Step 2: On All reports, use Category chips (Incentive, etc.) or search Filter reports by name.',
          'Step 3: Click Reward points under Incentive — open the reward points report (see below).',
        ],
        image: '/employee-help-reward-points-report-all-reports.png?v=0701a',
        imageAlt:
          'All reports page with Reward points report card under Incentive highlighted and click callout',
        imageWide: true,
        bodyEnd: [
          { heading: 'By member report' },
          'On the BY MEMBER tab, see each member’s reward points — earned (referrals and credits), used (redemptions), and current balance.',
          'Enter Member ID and click APPLY to filter one member. Use Search table to find any row, or click REFRESH to reload latest data.',
        ],
        image3: '/employee-help-reward-points-report-by-member.png?v=0701b',
        image3Alt:
          'Reward points report BY MEMBER tab with filter, APPLY, Earned, Used, Balance table, and numbered guide',
        image3Wide: true,
        image3Bleed: true,
        bodyAfterImage3: [
          ...
          'On the TRANSACTION LEDGER tab, see every reward point entry — when points were earned (referrals) or redeemed on a payment.',
          'Enter Member ID and click APPLY to filter. Use Search table or REFRESH to find rows and reload the latest ledger.',
        ],
        image4: '/employee-help-reward-points-report-transaction-ledger.png?v=0701c',
        image4Alt:
          'Reward points report TRANSACTION LEDGER tab with filter, APPLY, earn and redeem rows, and numbered guide',
        image4Wide: true,
        image4Bleed: true,
      },
      {
        ...
        articleGroup: 'all-categories',
        body: [
          { heading: 'What is BMI report?' },
          'BMI report helps you view and manage Body Mass Index (BMI) details of members — track their health status based on height and weight.',
          'It sits under Member progress on the All reports page, after Reward points report. Use it to monitor member fitness and body composition over time.',
          { heading: 'How to open' },
          'Open Reports from the left menu, go to All categories, then pick BMI manage from the report list.',
          'Step 1: Reports → All categories.',
          'Step 2: On All reports, use Category chips (Member progress, etc.) or search Filter reports by name.',
          'Step 3: Click BMI manage under Member progress — open BMI details (see below).',
        ],
        image: '/employee-help-bmi-report-all-reports.png?v=0701d',
        imageAlt:
          'All reports page with BMI manage card under Member progress highlighted and click callout',
        imageWide: true,
        bodyEnd: [
          { heading: 'BMI & Body Measurement Records page' },
          { heading: 'What this page shows' },
          'After you click BMI manage, the BMI & Body Measurement Records page opens — each member’s weight, height, BMI, body fat %, muscle %, and visceral fat.',
          'Filter by member and date range to view specific records. Use ADD BMI REPORT or + ADD NEW REPORT to enter new measurements.',
          { heading: 'How to use this page' },
          'Step 4: Pick Filter By Member and Select Date Range to load records.',
          'Step 5: Check the table — Weight, Height, B.M.I, Body Fat %, Muscle %, Visceral Fat.',
          'Step 6: Use Edit, View, or Delete in Actions to update or remove a record (see guide below).',
        ],
        image3: '/employee-help-bmi-report-page.png?v=0701e',
        image3Alt:
          'BMI and Body Measurement Records page with filters, table, ADD BMI REPORT, and numbered guide',
        image3Wide: true,
        image3Bleed: true,
        bodyAfterImage3: [
          { heading: 'How to add a BMI report' },
          'Step 1: On the BMI & Body Measurement Records page, click ADD BMI REPORT (top right) or + ADD NEW REPORT.',
          'Step 2: Select the member from the list.',
          'Step 3: Enter weight, height, and body measurements, then save the report.',
        ],
        image4: '/employee-help-bmi-report-add.png?v=0701f',
        image4Alt:
          'BMI page with ADD BMI REPORT button highlighted and numbered guide',
        image4Wide: true,
        image4Bleed: true,
      },
      {
        title: 'Staff target report',
        articleGroup: 'all-categories',
        body: [
          { heading: 'What is Staff target report?' },
          'Staff target report helps you view and track staff-wise target assignments — target amounts, achievements, and pending targets for the period you pick.',
          'It sits under Staff on the All reports page, after BMI report. Use it to monitor staff performance against their sales or collection targets.',
          { heading: 'How to open' },
          'Open Reports from the left menu, go to All categories, then pick Staff target from the report list.',
          'Step 1: Reports → All categories.',
          'Step 2: On All reports, use Category chips (Staff, etc.) or search Filter reports by name.',
          'Step 3: Click Staff target under Staff — open the staff target report (see below).',
        ],
        image: '/employee-help-staff-target-report-all-reports.png?v=0630h',
        imageAlt:
          'All reports page with Staff target report card under Staff highlighted and click callout',
        imageWide: true,
        bodyEnd: [
          { heading: 'Staff Target page' },
          { heading: 'What this page shows' },
          'After you click Staff target, the Staff Target page opens — set, track, and analyze trainer targets and collections for the month you pick.',
          'Use tabs to switch between Target & collection report, Performance dashboard, and Monthly collection trend. The table shows target, collection, % achieved, slab incentive, and net amount per trainer.',
          { heading: 'How to use this page' },
          'Step 4: Pick Month and Year → click Refresh to load data.',
          'Step 5: Open Target & collection report — check each trainer’s target, collection, and % Achieved.',
          'Step 6: Compare trainers in the chart · switch tabs for performance or monthly trend (see guide below).',
        ],
        image3: '/employee-help-staff-target-report-page.png?v=0630i',
        image3Alt:
          'Staff Target page with filters, trainer table, collection vs target chart, and numbered guide',
        image3Wide: true,
        image3Bleed: true,
      },
      {
